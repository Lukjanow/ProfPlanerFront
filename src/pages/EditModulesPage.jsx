import {RadioGroup, Radio, Input, Checkbox, select} from "@nextui-org/react";
...
export default function DropDownTestPage() {
    ...
    return (
        <>
            <div style={{position: "relative", display: "flex", margin: "40px", alignItems: "center"}}>
                <PageTitle text="Neues Modul" margin="0px"/>
                <div style={{
                    position: "absolute",
                    display: "flex",
                    right: "0px",
            ...
            <SectionContainer title={"Allgemein"}>
                <div style={{display: "flex", gap: "25px", marginBottom: "25px"}}>
                    <DropDown Items={testData} description="Studiengang"
                        add={{href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
                        Item: "item"}}
                        width="500px">
                    </DropDown>
                    <DropDown Items={testData} description="Fachsemester" selectionMode="multiple"
                        add={{href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
                        Item: "item"}}>
                    </DropDown>
                    <DropDown Items={testData} description="Wird angeboten in"
                        add={{href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
                        Item: "item"}}>
                    </DropDown>
                    <Checkbox
                ...
                {(selectedType == "QSP") ? 
                <DropDown Items={testData} description="Qualifikationsschwerpunkt"
                    add={{href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
                    Item: "item"}}
                    width="500px">
                </DropDown>: 
                null}
                <div style={{display: "flex", gap: "25px", marginTop: "25px",marginBottom: "25px"}}>
            ...
            <SectionContainer title={"Vorlesung"}>
                <div style={{display: "flex", gap: "25px", marginTop: "25px"}}>
                    <DropDown Items={testData} description="Lehrperson" selectionMode="multiple"
                        add={{href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
                        Item: "item"}}
                        width="500px">
                    </DropDown>
                    <DropDown Items={testData} description="Assistent" selectionMode="multiple"
                        add={{href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
                        Item: "item"}}>
                    </DropDown>
                    <DropDown Items={testData} description="Wunschraum"
                        add={{href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
                        Item: "item"}}>
                    </DropDown>
                </div>
