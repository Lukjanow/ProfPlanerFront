...
export function TimeTableFilter() {
  return (
    <div className="flex w-full flex-col">
      <Tabs radius="none" color="white" classNames={{tabList:"rounded-none p-0 gap-1"}}>
        <Tab key="tab1" title="Tab 1" className="shadow-none border-b-0 bg-white">
        ...
        <Tab key="tab2" title="Tab 2" className="shadow-none border-b-0 bg-white">
        ...
        <Tab key="tab3" title="Tab 3" className="shadow-none border-b-0 bg-white">
